...
public class RG2GI7LDp implements sn3fLZljc {
    ...
    public boolean qVUwofr5s(MenuItem menuItem, HelDswbLq helDswbLq, int i) {
        boolean z;
        tDC1iJlG1 tdc1ijlg1 = (tDC1iJlG1) menuItem;
        boolean z2 = false;
        if (tdc1ijlg1 == null || !tdc1ijlg1.isEnabled()) {
            return false;
        }
        MenuItem.OnMenuItemClickListener onMenuItemClickListener = tdc1ijlg1.MzoOEjc4X;
        if (onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(tdc1ijlg1)) {
            RG2GI7LDp rG2GI7LDp = tdc1ijlg1.Bhmn1KIah;
            if (!rG2GI7LDp.kCA6Zs9sL(rG2GI7LDp, tdc1ijlg1)) {
                Intent intent = tdc1ijlg1.GPLPRo6go;
                if (intent != null) {
                    try {
                        tdc1ijlg1.Bhmn1KIah.q3BipwRCk.startActivity(intent);
                    } catch (ActivityNotFoundException e) {
                        Log.e("MenuItemImpl", "Can't find activity to handle intent; ignoring", e);
                    }
                }
                iMp2wcpT4 imp2wcpt4 = tdc1ijlg1.iMyQMM6Qj;
                if (imp2wcpt4 == null || !imp2wcpt4.J4Ux7ym32.onPerformDefaultAction()) {
                    z = false;
                    iMp2wcpT4 imp2wcpt42 = tdc1ijlg1.iMyQMM6Qj;
                    boolean z3 = imp2wcpt42 == null && imp2wcpt42.J4Ux7ym32.hasSubMenu();
                    if (!tdc1ijlg1.iiGwOFFnr()) {
                        z |= tdc1ijlg1.expandActionView();
                    } else if (tdc1ijlg1.hasSubMenu() || z3) {
                        if ((i & 4) == 0) {
                            tGV7Q6urW(false);
                        }
                        if (!tdc1ijlg1.hasSubMenu()) {
                        ...
                        anclinfG8 anclinfg82 = tdc1ijlg1.PSTqBLTET;
                        if (z3) {
                            ActionProvider actionProvider = imp2wcpt42.J4Ux7ym32;
                            Objects.requireNonNull(imp2wcpt42.tGV7Q6urW);
                            actionProvider.onPrepareSubMenu(anclinfg82);
                        }
                        if (!this.RG6kpfv3v.isEmpty()) {
                            if (helDswbLq != null) {
                                z2 = helDswbLq.kCA6Zs9sL(anclinfg82);
                            }
                            Iterator it = this.RG6kpfv3v.iterator();
                            while (it.hasNext()) {
                                WeakReference weakReference = (WeakReference) it.next();
                                ...
                                if (helDswbLq2 == null) {
                                    ...
                                    z2 = helDswbLq2.kCA6Zs9sL(anclinfg82);
                                }
                            }
                        }
                        z |= z2;
        ...
        z = true;
        iMp2wcpT4 imp2wcpt422 = tdc1ijlg1.iMyQMM6Qj;
        if (imp2wcpt422 == null) {
        }
        if (!tdc1ijlg1.iiGwOFFnr()) {
        }
