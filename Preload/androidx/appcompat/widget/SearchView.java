...
public class SearchView extends RG2GI7LDp implements GsWcrrhpK {
    ...
    public final void dfpT1j18n(boolean z) {
        boolean z2 = this.XYT7vJqNO;
        int i = 0;
        if (z2) {
            if ((z2 || this.ln3nf7LH3) && !this.BL4OzhZBd) {
                if (hasFocus()) {
                    if (!z) {
                    }
                    this.nlGCs0NZs.setVisibility(i);
                }
            }
        }
        i = 8;
    ...
    public void setSearchableInfo(SearchableInfo searchableInfo) {
        this.buPcffgdD = searchableInfo;
        boolean z = true;
        Intent intent = null;
        if (searchableInfo != null) {
            this.iMyQMM6Qj.setThreshold(searchableInfo.getSuggestThreshold());
            this.iMyQMM6Qj.setImeOptions(this.buPcffgdD.getImeOptions());
            int inputType = this.buPcffgdD.getInputType();
            if ((inputType & 15) == 1) {
                inputType &= -65537;
                if (this.buPcffgdD.getSuggestAuthority() != null) {
                    inputType = inputType | 65536 | 524288;
                }
            }
            this.iMyQMM6Qj.setInputType(inputType);
            IkIPSLCvr ikIPSLCvr = this.DuuXfa7LE;
            if (ikIPSLCvr != null) {
                ikIPSLCvr.J4Ux7ym32(null);
            }
            if (this.buPcffgdD.getSuggestAuthority() != null) {
                Y8Y0XSE4A y8y0xse4a = new Y8Y0XSE4A(getContext(), this, this.buPcffgdD, this.YmNRDyka4);
                this.DuuXfa7LE = y8y0xse4a;
                this.iMyQMM6Qj.setAdapter(y8y0xse4a);
                ((Y8Y0XSE4A) this.DuuXfa7LE).cAwN510t2 = this.KBYw84i3W ? 2 : 1;
            }
            WaUP0CF08();
        }
        SearchableInfo searchableInfo2 = this.buPcffgdD;
        z = false;
        if (searchableInfo2 != null && searchableInfo2.getVoiceSearchEnabled()) {
            if (this.buPcffgdD.getVoiceSearchLaunchWebSearch()) {
                intent = this.j22ftfeNI;
            } else if (this.buPcffgdD.getVoiceSearchLaunchRecognizer()) {
                intent = this.QSbMsHU5X;
            }
            if (intent != null) {
            }
        }
        this.ln3nf7LH3 = z;
        if (z) {
            this.iMyQMM6Qj.setPrivateImeOptions("nm");
        }
