...
public class RG2GI7LDp {
    ...
    public void Bhmn1KIah() {
        ...
        if (fVMSvDhE6.juJ6pnCpu(3)) {
            StringBuilder q3BipwRCk = abGBwSu8x.q3BipwRCk("moveto RESUMED: ");
        ...
        View view = rwmikndwl == null ? null : rwmikndwl.PSTqBLTET;
        if (view != null) {
            if (view != uxHHqhbTP.EBQXiIPmm) {
                for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                    if (parent != this.tGV7Q6urW.EBQXiIPmm) {
                    }
                }
                z = false;
                if (z) {
                    ...
                    if (fVMSvDhE6.juJ6pnCpu(2)) {
                        ...
                        sb.append(this.tGV7Q6urW.EBQXiIPmm.findFocus());
        ...
        this.tGV7Q6urW.DuuXfa7LE(null);
        UxHHqhbTP uxHHqhbTP2 = this.tGV7Q6urW;
        uxHHqhbTP2.qFBXIgpia.IzM1cD9ly();
        uxHHqhbTP2.qFBXIgpia.qFBXIgpia(true);
        uxHHqhbTP2.CBQ5d1kRq = 7;
        uxHHqhbTP2.QNqj6nIzv = false;
        uxHHqhbTP2.QNqj6nIzv = true;
        N0a4Shkkl n0a4Shkkl = uxHHqhbTP2.wIZEdYHUn;
        mhl5lIdbQ.RG2GI7LDp rG2GI7LDp = mhl5lIdbQ.RG2GI7LDp.ON_RESUME;
        n0a4Shkkl.kCA6Zs9sL(rG2GI7LDp);
        if (uxHHqhbTP2.EBQXiIPmm != null) {
            uxHHqhbTP2.IzM1cD9ly.J4Ux7ym32(rG2GI7LDp);
        }
        fVMSvDhE6 fvmsvdhe6 = uxHHqhbTP2.qFBXIgpia;
        fvmsvdhe6.cAwN510t2 = false;
        fvmsvdhe6.IytU16YUK = false;
        fvmsvdhe6.vNtjxmzUM.GPLPRo6go = false;
        fvmsvdhe6.i8XZMQc6Z(7);
        this.q3BipwRCk.oon79WMrY(this.tGV7Q6urW, false);
        UxHHqhbTP uxHHqhbTP3 = this.tGV7Q6urW;
        uxHHqhbTP3.kmSgne1rO = null;
        uxHHqhbTP3.Bhmn1KIah = null;
        uxHHqhbTP3.PSTqBLTET = null;
    }
    ...
    public void J4Ux7ym32() {
        View view;
        j6XJY7rz4 j6xjy7rz4 = this.J4Ux7ym32;
        UxHHqhbTP uxHHqhbTP = this.tGV7Q6urW;
        Objects.requireNonNull(j6xjy7rz4);
        ViewGroup viewGroup = uxHHqhbTP.igRQEZxnW;
        int i = -1;
        if (viewGroup != null) {
            int indexOf = ((ArrayList) j6xjy7rz4.kmSgne1rO).indexOf(uxHHqhbTP);
            int i2 = indexOf - 1;
            while (true) {
                if (i2 >= 0) {
                    UxHHqhbTP uxHHqhbTP2 = (UxHHqhbTP) ((ArrayList) j6xjy7rz4.kmSgne1rO).get(i2);
                    if (uxHHqhbTP2.igRQEZxnW == viewGroup && (view = uxHHqhbTP2.EBQXiIPmm) != null) {
        ...
        UxHHqhbTP uxHHqhbTP3 = this.tGV7Q6urW;
        uxHHqhbTP3.igRQEZxnW.addView(uxHHqhbTP3.EBQXiIPmm, i);
    }
