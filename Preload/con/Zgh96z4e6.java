...
public class Zgh96z4e6 implements JEWwjBE8f, f1p7dM0A1, JdgJLcZNG {
    ...
    public final boolean vPSbyrYWX(Object obj) {
        vX9ZKIhAp vx9zkihap;
        boolean z;
        vX9ZKIhAp vx9zkihap2 = AB5ApHoQM.q3BipwRCk;
        if (ixWaw2akD()) {
            do {
                Object i8XZMQc6Z = i8XZMQc6Z();
                if (!(i8XZMQc6Z instanceof S35qAAg28) || ((i8XZMQc6Z instanceof WEtyFPo1W) && ((WEtyFPo1W) i8XZMQc6Z).GPLPRo6go())) {
                    vx9zkihap2 = AB5ApHoQM.q3BipwRCk;
                    break;
                }
                vx9zkihap2 = EBQXiIPmm(i8XZMQc6Z, new zo6RfsWe2(ilHKhw3Yw(obj), false, 2));
            } while (vx9zkihap2 == AB5ApHoQM.tGV7Q6urW);
            if (vx9zkihap2 == AB5ApHoQM.J4Ux7ym32) {
                return true;
            }
        }
        if (vx9zkihap2 == AB5ApHoQM.q3BipwRCk) {
            Throwable th = null;
            Throwable th2 = null;
            while (true) {
                Object i8XZMQc6Z2 = i8XZMQc6Z();
                if (!(i8XZMQc6Z2 instanceof WEtyFPo1W)) {
                    if (!(i8XZMQc6Z2 instanceof S35qAAg28)) {
                        vx9zkihap = AB5ApHoQM.dIocxURUo;
                        break;
                    }
                    if (th2 == null) {
                        th2 = ilHKhw3Yw(obj);
                    }
                    S35qAAg28 s35qAAg28 = (S35qAAg28) i8XZMQc6Z2;
                    if (s35qAAg28.J4Ux7ym32()) {
                        NohLR2A3H sk5s77z6Q = sk5s77z6Q(s35qAAg28);
                        if (sk5s77z6Q != null) {
                            if (CBQ5d1kRq.compareAndSet(this, s35qAAg28, new WEtyFPo1W(sk5s77z6Q, false, th2))) {
                                NyWTwPF6V(sk5s77z6Q, th2);
                                z = true;
                                if (!z) {
                                    break;
                                }
                        ...
                        Object EBQXiIPmm = EBQXiIPmm(i8XZMQc6Z2, new zo6RfsWe2(th2, false, 2));
                        if (EBQXiIPmm != AB5ApHoQM.q3BipwRCk) {
                            if (EBQXiIPmm != AB5ApHoQM.tGV7Q6urW) {
                                vx9zkihap2 = EBQXiIPmm;
                                break;
                            }
                        } else {
                            throw new IllegalStateException(anXlDk6fV.iMyQMM6Qj("Cannot happen in ", i8XZMQc6Z2).toString());
                        }
                    }
                } else {
                    synchronized (i8XZMQc6Z2) {
                        if (((WEtyFPo1W) i8XZMQc6Z2).Puu3Rhg4F()) {
                            vx9zkihap = AB5ApHoQM.dIocxURUo;
                        } else {
                            boolean iiGwOFFnr = ((WEtyFPo1W) i8XZMQc6Z2).iiGwOFFnr();
                            if (obj != null || !iiGwOFFnr) {
                                if (th2 == null) {
                                    th2 = ilHKhw3Yw(obj);
                                }
                                ((WEtyFPo1W) i8XZMQc6Z2).q3BipwRCk(th2);
                            }
                            th = ((WEtyFPo1W) i8XZMQc6Z2).dIocxURUo();
                            if (!iiGwOFFnr) {
                            }
                            if (th != null) {
                                NyWTwPF6V(((WEtyFPo1W) i8XZMQc6Z2).CBQ5d1kRq, th);
                            }
                        }
                    }
                }
            ...
            vx9zkihap = AB5ApHoQM.q3BipwRCk;
            vx9zkihap2 = vx9zkihap;
        }
        if (!(vx9zkihap2 == AB5ApHoQM.q3BipwRCk || vx9zkihap2 == AB5ApHoQM.J4Ux7ym32)) {
            if (vx9zkihap2 == AB5ApHoQM.dIocxURUo) {
                return false;
            }
            Puu3Rhg4F(vx9zkihap2);
        }
        return true;
    }
