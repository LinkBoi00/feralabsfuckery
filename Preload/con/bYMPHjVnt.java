...
public final class bYMPHjVnt extends cywn6086a implements uynHRf1qF {
    ...
    public final boolean cAwN510t2(PmanMZxiM pmanMZxiM) {
        int i;
        int mUqPm6GBh = mUqPm6GBh();
        Object[] objArr = null;
        DGdyNqLvN dGdyNqLvN = new DGdyNqLvN(null, 1);
        ...
        if (this.ilHKhw3Yw != null) {
            ListIterator kmSgne1rO = kmSgne1rO(0);
            int i2 = 32;
            int i3 = 32;
            while (i3 == 32 && ((wwj2VvJy1) kmSgne1rO).hasNext()) {
                i3 = dfpT1j18n(pmanMZxiM, (Object[]) kmSgne1rO.next(), 32, dGdyNqLvN);
            }
            if (i3 == 32) {
                wwj2VvJy1 wwj2vvjy1 = (wwj2VvJy1) kmSgne1rO;
                int iMyQMM6Qj = iMyQMM6Qj(pmanMZxiM, mUqPm6GBh, dGdyNqLvN);
                if (iMyQMM6Qj == 0) {
                    dXrmkklc8(this.ilHKhw3Yw, this.Eeka1udhb, this.PSTqBLTET);
                }
            } else {
                wwj2VvJy1 wwj2vvjy12 = (wwj2VvJy1) kmSgne1rO;
                int i4 = (wwj2vvjy12.CBQ5d1kRq - 1) << 5;
                ArrayList arrayList = new ArrayList();
                List arrayList2 = new ArrayList();
                int i5 = i3;
                while (wwj2vvjy12.hasNext()) {
                    i5 = i8XZMQc6Z(pmanMZxiM, (Object[]) kmSgne1rO.next(), 32, i5, dGdyNqLvN, arrayList2, arrayList);
                    i4 = i4;
                    i2 = i2;
                    wwj2vvjy12 = wwj2vvjy12;
                }
                int i8XZMQc6Z = i8XZMQc6Z(pmanMZxiM, this.qVUwofr5s, mUqPm6GBh, i5, dGdyNqLvN, arrayList2, arrayList);
                ...
                Arrays.fill(objArr2, i8XZMQc6Z, i2, (Object) null);
                Object[] RG6kpfv3v = arrayList.isEmpty() ? this.ilHKhw3Yw : RG6kpfv3v(this.ilHKhw3Yw, i4, this.PSTqBLTET, arrayList.iterator());
                ...
                if ((size & 31) == 0) {
                    if (size == 0) {
                        ...
                        while (true) {
                            ...
                            this.PSTqBLTET = i - 5;
                            Object obj = RG6kpfv3v[0];
                            Objects.requireNonNull(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                            RG6kpfv3v = (Object[]) obj;
                        }
                        objArr = qVUwofr5s(RG6kpfv3v, i6, i);
                    }
                    this.ilHKhw3Yw = objArr;
                    this.qVUwofr5s = objArr2;
                    this.Eeka1udhb = size + i8XZMQc6Z;
                    z = true;
                } else {
                    throw new IllegalStateException("Check failed.".toString());
                }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump */
    public final int dfpT1j18n(PmanMZxiM pmanMZxiM, Object[] objArr, int i, DGdyNqLvN dGdyNqLvN) {
        if (i > 0) {
            int i2 = 0;
