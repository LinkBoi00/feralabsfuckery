...
public abstract class D3DEikrvb {
    ...
    public static alvSTFvn7 PSTqBLTET(TextView textView) {
        TextDirectionHeuristic textDirectionHeuristic;
        int i = Build.VERSION.SDK_INT;
        if (i >= 28) {
            return new alvSTFvn7(textView.getTextMetricsParams());
        }
        ...
        if (!(textView.getTransformationMethod() instanceof PasswordTransformationMethod)) {
            ...
            return new alvSTFvn7(textPaint, textDirectionHeuristic, breakStrategy, hyphenationFrequency);
        }
