...
public class WLlBJNJ2W {
    ...
    public void tGV7Q6urW(uXZOTWgvT uxzotwgvt) {
        boolean z;
        boolean z2;
        boolean z3;
        miIsFJ8kP miisfj8kp;
        miIsFJ8kP vPSbyrYWX;
        boolean z4 = true;
        if (this.oon79WMrY + 1 >= this.vPSbyrYWX || this.yWvV4ePLl + 1 >= this.kCA6Zs9sL) {
            MzoOEjc4X();
        }
        if (!uxzotwgvt.kCA6Zs9sL) {
            if (this.iiGwOFFnr.length != 0) {
                boolean z5 = false;
                while (!z5) {
                    int vPSbyrYWX2 = uxzotwgvt.dIocxURUo.vPSbyrYWX();
                    for (int i = 0; i < vPSbyrYWX2; i++) {
                        miIsFJ8kP kCA6Zs9sL = uxzotwgvt.dIocxURUo.kCA6Zs9sL(i);
                        if (kCA6Zs9sL.Bhmn1KIah != -1 || kCA6Zs9sL.ilHKhw3Yw) {
                            uxzotwgvt.tGV7Q6urW.add(kCA6Zs9sL);
                        }
                    }
                    int size = uxzotwgvt.tGV7Q6urW.size();
                    if (size > 0) {
                        for (int i2 = 0; i2 < size; i2++) {
                            miIsFJ8kP miisfj8kp2 = (miIsFJ8kP) uxzotwgvt.tGV7Q6urW.get(i2);
                            if (miisfj8kp2.ilHKhw3Yw) {
                                uxzotwgvt.kmSgne1rO(this, miisfj8kp2, true);
                            } else {
                                uxzotwgvt.Bhmn1KIah(this, this.iiGwOFFnr[miisfj8kp2.Bhmn1KIah], true);
                            }
                        }
                        uxzotwgvt.tGV7Q6urW.clear();
                    } else {
                        z5 = true;
                    }
                }
                if (uxzotwgvt.q3BipwRCk != null && uxzotwgvt.dIocxURUo.vPSbyrYWX() == 0) {
                    uxzotwgvt.kCA6Zs9sL = true;
                    this.q3BipwRCk = true;
                }
            }
            if (!uxzotwgvt.yWvV4ePLl()) {
                float f = uxzotwgvt.J4Ux7ym32;
                if (f < 0.0f) {
                    uxzotwgvt.J4Ux7ym32 = f * -1.0f;
                    uxzotwgvt.dIocxURUo.oon79WMrY();
                }
                int vPSbyrYWX3 = uxzotwgvt.dIocxURUo.vPSbyrYWX();
                float f2 = 0.0f;
                float f3 = 0.0f;
                miIsFJ8kP miisfj8kp3 = null;
                miIsFJ8kP miisfj8kp4 = null;
                boolean z6 = false;
                boolean z7 = false;
                for (int i3 = 0; i3 < vPSbyrYWX3; i3++) {
                    float q3BipwRCk = uxzotwgvt.dIocxURUo.q3BipwRCk(i3);
                    miIsFJ8kP kCA6Zs9sL2 = uxzotwgvt.dIocxURUo.kCA6Zs9sL(i3);
                    if (kCA6Zs9sL2.dXrmkklc8 == 1) {
                        if (miisfj8kp3 == null || f2 > q3BipwRCk) {
                            z6 = uxzotwgvt.oon79WMrY(kCA6Zs9sL2);
                        } else if (!z6 && uxzotwgvt.oon79WMrY(kCA6Zs9sL2)) {
                            z6 = true;
                        }
                        miisfj8kp3 = kCA6Zs9sL2;
                        f2 = q3BipwRCk;
                    } else if (miisfj8kp3 == null && q3BipwRCk < 0.0f) {
                        if (miisfj8kp4 == null || f3 > q3BipwRCk) {
                            z7 = uxzotwgvt.oon79WMrY(kCA6Zs9sL2);
                        } else if (!z7 && uxzotwgvt.oon79WMrY(kCA6Zs9sL2)) {
                            z7 = true;
                        }
                        miisfj8kp4 = kCA6Zs9sL2;
                        f3 = q3BipwRCk;
                    }
                }
                if (miisfj8kp3 == null) {
                    miisfj8kp3 = miisfj8kp4;
                }
                if (miisfj8kp3 == null) {
                    z2 = true;
                } else {
                    uxzotwgvt.CBQ5d1kRq(miisfj8kp3);
                    z2 = false;
                }
                if (uxzotwgvt.dIocxURUo.vPSbyrYWX() == 0) {
                    uxzotwgvt.kCA6Zs9sL = true;
                }
                if (z2) {
                    if (this.yWvV4ePLl + 1 >= this.kCA6Zs9sL) {
                    ...
                    miIsFJ8kP q3BipwRCk2 = q3BipwRCk(3, null);
                    int i4 = this.J4Ux7ym32 + 1;
                    this.J4Ux7ym32 = i4;
                    this.yWvV4ePLl++;
                    q3BipwRCk2.kmSgne1rO = i4;
                    ((miIsFJ8kP[]) this.CBQ5d1kRq.dIocxURUo)[i4] = q3BipwRCk2;
                    uxzotwgvt.q3BipwRCk = q3BipwRCk2;
                    int i5 = this.oon79WMrY;
                    yWvV4ePLl(uxzotwgvt);
                    if (this.oon79WMrY == i5 + 1) {
                        uXZOTWgvT uxzotwgvt2 = this.PSTqBLTET;
                        Objects.requireNonNull(uxzotwgvt2);
                        uxzotwgvt2.q3BipwRCk = null;
                        uxzotwgvt2.dIocxURUo.clear();
                        for (int i6 = 0; i6 < uxzotwgvt.dIocxURUo.vPSbyrYWX(); i6++) {
                            uxzotwgvt2.dIocxURUo.GPLPRo6go(uxzotwgvt.dIocxURUo.kCA6Zs9sL(i6), uxzotwgvt.dIocxURUo.q3BipwRCk(i6), true);
                        }
                        Eeka1udhb(this.PSTqBLTET);
                        if (q3BipwRCk2.Bhmn1KIah == -1) {
                            if (uxzotwgvt.q3BipwRCk == q3BipwRCk2 && (vPSbyrYWX = uxzotwgvt.vPSbyrYWX(null, q3BipwRCk2)) != null) {
                                uxzotwgvt.CBQ5d1kRq(vPSbyrYWX);
                            }
                            if (!uxzotwgvt.kCA6Zs9sL) {
                                uxzotwgvt.q3BipwRCk.kCA6Zs9sL(this, uxzotwgvt);
                            }
                            ((nOPp9PCGN) this.CBQ5d1kRq.J4Ux7ym32).tGV7Q6urW(uxzotwgvt);
                            this.oon79WMrY--;
                        }
                        z3 = true;
                        miisfj8kp = uxzotwgvt.q3BipwRCk;
                        if (miisfj8kp != null || (miisfj8kp.dXrmkklc8 != 1 && uxzotwgvt.J4Ux7ym32 < 0.0f)) {
                            z4 = false;
                        }
                        if (!z4) {
                            z = z3;
