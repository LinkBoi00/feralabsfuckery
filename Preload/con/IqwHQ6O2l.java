...
public class IqwHQ6O2l {
    ...
    public String toString() {
        ...
        Rect rect = new Rect();
        this.q3BipwRCk.getBoundsInParent(rect);
        sb.append("; boundsInParent: " + rect);
        this.q3BipwRCk.getBoundsInScreen(rect);
        sb.append("; boundsInScreen: " + rect);
        sb.append("; packageName: ");
        sb.append(this.q3BipwRCk.getPackageName());
        sb.append("; className: ");
        sb.append(this.q3BipwRCk.getClassName());
        sb.append("; text: ");
        sb.append(yWvV4ePLl());
        sb.append("; contentDescription: ");
        sb.append(kCA6Zs9sL());
        sb.append("; viewId: ");
        sb.append(this.q3BipwRCk.getViewIdResourceName());
        sb.append("; checkable: ");
        sb.append(this.q3BipwRCk.isCheckable());
        sb.append("; checked: ");
        sb.append(this.q3BipwRCk.isChecked());
        sb.append("; focusable: ");
        sb.append(oon79WMrY());
        sb.append("; focused: ");
        sb.append(vPSbyrYWX());
        sb.append("; selected: ");
        sb.append(this.q3BipwRCk.isSelected());
        sb.append("; clickable: ");
        sb.append(this.q3BipwRCk.isClickable());
        sb.append("; longClickable: ");
        sb.append(this.q3BipwRCk.isLongClickable());
        sb.append("; enabled: ");
        sb.append(this.q3BipwRCk.isEnabled());
        sb.append("; password: ");
        sb.append(this.q3BipwRCk.isPassword());
        sb.append("; scrollable: " + this.q3BipwRCk.isScrollable());
        sb.append("; [");
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.q3BipwRCk.getActionList();
        if (actionList != null) {
            r3 = new ArrayList();
            int size = actionList.size();
            for (int i = 0; i < size; i++) {
                r3.add(new RG2GI7LDp(actionList.get(i), 0, null, null, null));
            }
        } else {
            r3 = Collections.emptyList();
        }
        for (int i2 = 0; i2 < r3.size(); i2++) {
            RG2GI7LDp rG2GI7LDp = (RG2GI7LDp) r3.get(i2);
            String tGV7Q6urW = tGV7Q6urW(rG2GI7LDp.q3BipwRCk());
            if (tGV7Q6urW.equals("ACTION_UNKNOWN") && rG2GI7LDp.J4Ux7ym32() != null) {
                tGV7Q6urW = rG2GI7LDp.J4Ux7ym32().toString();
            }
            sb.append(tGV7Q6urW);
            if (i2 != r3.size() - 1) {
                sb.append(", ");
