...
public abstract class xpuSUT7Gh {
    ...
    public static final KB2jjcOAK Dr7UqlxEV(pLYbCSTk0 plybcstk0, pnuAOe8oh pnuaoe8oh, boolean z) {
        ...
        if (i > 0) {
            ...
            do {
                ...
                KB2jjcOAK IzM1cD9ly = plybcstk02.V9LQMKGJe.ilHKhw3Yw.IzM1cD9ly(z);
                if (IzM1cD9ly != null) {
                    return IzM1cD9ly;
                }
                pnuaoe8oh.J4Ux7ym32(plybcstk02);
                i2++;
            } while (i2 < i);
            while (pnuaoe8oh.oon79WMrY()) {
                KB2jjcOAK Dr7UqlxEV = Dr7UqlxEV((pLYbCSTk0) pnuaoe8oh.CBQ5d1kRq(0), pnuaoe8oh, z);
                if (Dr7UqlxEV != null) {
                    return Dr7UqlxEV;
                }
            }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump */
    public static final long J4Ux7ym32(float f, float f2, float f3, float f4, J8UIfudgU j8UIfudgU) {
        boolean z;
        boolean z2 = false;
        if (f <= j8UIfudgU.J4Ux7ym32(0) && j8UIfudgU.tGV7Q6urW(0) <= f) {
            if (f2 <= j8UIfudgU.J4Ux7ym32(1) && j8UIfudgU.tGV7Q6urW(1) <= f2) {
                if (f3 <= j8UIfudgU.J4Ux7ym32(2) && j8UIfudgU.tGV7Q6urW(2) <= f3) {
                    if (0.0f <= f4 && f4 <= 1.0f) {
                        z = true;
                        if (z) {
                            throw new IllegalArgumentException(("red = " + f + ", green = " + f2 + ", blue = " + f3 + ", alpha = " + f4 + " outside the range for " + j8UIfudgU).toString());
                        } else if (j8UIfudgU.dIocxURUo()) {
                            ...
                            long j2 = j8UIfudgU.J4Ux7ym32;
                            JhpbRXxsg jhpbRXxsg2 = eAsjC32WK.q3BipwRCk;
                            if (((int) (j2 >> 32)) == 3) {
                                int i = j8UIfudgU.tGV7Q6urW;
                                if (i != -1) {
                                    z2 = true;
                                }
                                if (z2) {
                                    long q3BipwRCk = ((((long) dBsFbrhJp.q3BipwRCk(f2)) & 65535) << 32) | ((((long) dBsFbrhJp.q3BipwRCk(f)) & 65535) << 48) | ((((long) dBsFbrhJp.q3BipwRCk(f3)) & 65535) << 16) | ((((long) ((int) ((Math.max(0.0f, Math.min(f4, 1.0f)) * 1023.0f) + 0.5f))) & 1023) << 6) | (((long) i) & 63);
                                    JhpbRXxsg jhpbRXxsg3 = bO2dbmrf7.J4Ux7ym32;
                                    return q3BipwRCk;
                                }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump */
    public static final void iiGwOFFnr(String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, List list, kkcQgCx5G kkcqgcx5g, rJ0s9PfCL rj0s9pfcl, int i, int i2) {
        int i3;
        int i4;
        int i5;
        float f8;
        ...
        wpxpbwg1j3.ziwPzaoF3(383574212);
        Object obj = G7WvUK4mQ.q3BipwRCk;
        int i12 = i2 & 1;
        if (i12 != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
            i3 = (wpxpbwg1j3.iiGwOFFnr(str) ? 4 : 2) | i;
        } else {
            i3 = i;
        }
        int i13 = i2 & 2;
        if (i13 != 0) {
            ...
            i3 |= wpxpbwg1j3.tGV7Q6urW(f) ? 32 : 16;
            i4 = i2 & 4;
            if (i4 == 0) {
                i3 |= 384;
            } else if ((i & 896) == 0) {
                i3 |= wpxpbwg1j3.tGV7Q6urW(f2) ? 256 : 128;
                i5 = i2 & 8;
                if (i5 != 0) {
                    i3 |= 3072;
                } else if ((i & 7168) == 0) {
                    f8 = f3;
                    i3 |= wpxpbwg1j3.tGV7Q6urW(f8) ? 2048 : 1024;
                    i6 = i2 & 16;
                    if (i6 == 0) {
                        i3 |= 24576;
                    } else if ((57344 & i) == 0) {
                        i3 |= wpxpbwg1j3.tGV7Q6urW(f4) ? 16384 : 8192;
                        i7 = i2 & 32;
                        if (i7 != 0) {
                            i3 |= 196608;
                        } else if ((i & 458752) == 0) {
                            i3 |= wpxpbwg1j3.tGV7Q6urW(f5) ? 131072 : 65536;
                            i8 = i2 & 64;
                            if (i8 == 0) {
                                i3 |= 1572864;
                            } else if ((i & 3670016) == 0) {
                                i3 |= wpxpbwg1j3.tGV7Q6urW(f6) ? 1048576 : 524288;
                                i9 = i2 & 128;
                                if (i9 != 0) {
                                    i3 |= 12582912;
                                } else if ((i & 29360128) == 0) {
                                    i3 |= wpxpbwg1j3.tGV7Q6urW(f7) ? 8388608 : 4194304;
                                    i10 = i2 & 256;
                                    if (i10 != 0) {
                                        i3 |= 33554432;
                                    }
                                    if ((i2 & 512) == 0) {
                                        ...
                                        if ((1879048192 & i) == 0) {
                                            i11 = wpxpbwg1j3.iiGwOFFnr(kkcqgcx5g) ? 536870912 : 268435456;
                                        }
                                        if (((~i2) & 256) == 0 && ((1533916891 & i3) ^ 306783378) == 0) {
                                            wpxpbwg1j2 = wpxpbwg1j3;
                                            if (wpxpbwg1j2.i8XZMQc6Z()) {
                                                ...
                                                f19 = f7;
                                                list3 = list;
                                                Eeka1udhb = wpxpbwg1j3.Eeka1udhb();
                                                if (Eeka1udhb == null) {
                                                    Eeka1udhb.dIocxURUo = new z7GvhcHwx(str2, f16, f17, f8, f20, f18, f15, f19, list3, kkcqgcx5g, i, i2);
                                                    return;
                                                }
                                                return;
                                            }
                                        }
                                        wpxpbwg1j = wpxpbwg1j3;
                                        wpxpbwg1j.TyB1UUd72();
                                        if ((i & 1) != 0 || wpxpbwg1j.WaUP0CF08()) {
                                            ...
                                            if (i10 != 0) {
                                                int i14 = fpjpWAHwn.q3BipwRCk;
                                                list2 = Dqz1pJHWH.CBQ5d1kRq;
                                                i3 &= -234881025;
                                                wpxpbwg1j.qVUwofr5s();
                                                CVLDD9a7R cVLDD9a7R = CVLDD9a7R.kmSgne1rO;
                                                wpxpbwg1j.zHl31GGXU(-2103248186);
                                                if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                                                    wpxpbwg1j.QSbMsHU5X();
                                                    if (wpxpbwg1j.vNtjxmzUM) {
                                                        wpxpbwg1j.vPSbyrYWX(cVLDD9a7R);
                                                    } else {
                                                        wpxpbwg1j.ln3nf7LH3();
                                                    }
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, str2, gcz6RXeX5.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f13), vxIaIiNAm.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f12), n51tObduK.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f8), APDQ69YTZ.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f9), rf16Fcp5X.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f11), q0WhZ7Ufo.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f14), w19ucmuRv.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, Float.valueOf(f10), x796VfojB.kmSgne1rO);
                                                    pz7YPhQTU.WaUP0CF08(wpxpbwg1j3, list2, qzG2g43Qa.kmSgne1rO);
                                                    wpxpbwg1j.zHl31GGXU(-1894407238);
                                                    kkcqgcx5g.WaUP0CF08(wpxpbwg1j3, Integer.valueOf((i3 >> 27) & 14));
                                                    wpxpbwg1j.ilHKhw3Yw(false);
                                                    wpxpbwg1j.ilHKhw3Yw(true);
                                                    wpxpbwg1j.ilHKhw3Yw(false);
                                                    f15 = f14;
                                        ...
                                        list2 = list;
                                        wpxpbwg1j.qVUwofr5s();
                                        CVLDD9a7R cVLDD9a7R2 = CVLDD9a7R.kmSgne1rO;
                                        wpxpbwg1j.zHl31GGXU(-2103248186);
                                        if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                                        }
                                    }
                                    ...
                                    list2 = list;
                                    wpxpbwg1j.qVUwofr5s();
                                    CVLDD9a7R cVLDD9a7R22 = CVLDD9a7R.kmSgne1rO;
                                    wpxpbwg1j.zHl31GGXU(-2103248186);
                                    if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                                    }
                                }
                                ...
                                list2 = list;
                                wpxpbwg1j.qVUwofr5s();
                                CVLDD9a7R cVLDD9a7R222 = CVLDD9a7R.kmSgne1rO;
                                wpxpbwg1j.zHl31GGXU(-2103248186);
                                if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                                }
                            }
                            ...
                            list2 = list;
                            wpxpbwg1j.qVUwofr5s();
                            CVLDD9a7R cVLDD9a7R2222 = CVLDD9a7R.kmSgne1rO;
                            wpxpbwg1j.zHl31GGXU(-2103248186);
                            if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                            }
                        }
                        ...
                        list2 = list;
                        wpxpbwg1j.qVUwofr5s();
                        CVLDD9a7R cVLDD9a7R22222 = CVLDD9a7R.kmSgne1rO;
                        wpxpbwg1j.zHl31GGXU(-2103248186);
                        if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                        }
                    }
                    ...
                    list2 = list;
                    wpxpbwg1j.qVUwofr5s();
                    CVLDD9a7R cVLDD9a7R222222 = CVLDD9a7R.kmSgne1rO;
                    wpxpbwg1j.zHl31GGXU(-2103248186);
                    if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                    }
                }
                ...
                list2 = list;
                wpxpbwg1j.qVUwofr5s();
                CVLDD9a7R cVLDD9a7R2222222 = CVLDD9a7R.kmSgne1rO;
                wpxpbwg1j.zHl31GGXU(-2103248186);
                if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
                }
            }
            ...
            list2 = list;
            wpxpbwg1j.qVUwofr5s();
            CVLDD9a7R cVLDD9a7R22222222 = CVLDD9a7R.kmSgne1rO;
            wpxpbwg1j.zHl31GGXU(-2103248186);
            if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
            }
        }
        ...
        list2 = list;
        wpxpbwg1j.qVUwofr5s();
        CVLDD9a7R cVLDD9a7R222222222 = CVLDD9a7R.kmSgne1rO;
        wpxpbwg1j.zHl31GGXU(-2103248186);
        if (!(wpxpbwg1j.J4Ux7ym32 instanceof dGRcjwJnj)) {
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump */
    public static final void yWvV4ePLl(ZOOhBHi6I zOOhBHi6I, Map map, rJ0s9PfCL rj0s9pfcl, int i, int i2) {
        int i3;
        Map map2;
        Map map3;
        wpXpbWG1J wpxpbwg1j;
        ...
        wpxpbwg1j2.ziwPzaoF3(-326288533);
        Object obj = G7WvUK4mQ.q3BipwRCk;
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
            i3 = (wpxpbwg1j2.iiGwOFFnr(zOOhBHi6I) ? 4 : 2) | i;
        } else {
            i3 = i;
        }
        int i4 = i2 & 2;
        ...
        if ((2 & (~i2)) == 0 && ((i3 & 91) ^ 18) == 0 && wpxpbwg1j2.i8XZMQc6Z()) {
            wpxpbwg1j2.igRQEZxnW();
            map3 = map;
        } else {
            wpxpbwg1j2.TyB1UUd72();
            if ((i & 1) != 0 && !wpxpbwg1j2.WaUP0CF08()) {
                wpxpbwg1j2.igRQEZxnW();
            } else if (i4 != 0) {
                map2 = dmnvfTTyg.CBQ5d1kRq;
                wpxpbwg1j2.qVUwofr5s();
                for (WdHQbIkKn wdHQbIkKn : zOOhBHi6I.RG6kpfv3v) {
                    if (wdHQbIkKn instanceof Q7SwT3Brp) {
                        wpxpbwg1j2.zHl31GGXU(-326288360);
                        Object obj2 = G7WvUK4mQ.q3BipwRCk;
                        Q7SwT3Brp q7SwT3Brp = (Q7SwT3Brp) wdHQbIkKn;
                        ikJSs0pML ikjss0pml = (ikJSs0pML) map2.get(q7SwT3Brp.q3BipwRCk);
                        if (ikjss0pml == null) {
                            ikjss0pml = new DT9FV5y2G();
                        }
                        wpxpbwg1j = wpxpbwg1j2;
                        Puu3Rhg4F((List) ikjss0pml.q3BipwRCk(aJPUy2D2j.q3BipwRCk, q7SwT3Brp.J4Ux7ym32), q7SwT3Brp.tGV7Q6urW, q7SwT3Brp.q3BipwRCk, (bZmnXN812) ikjss0pml.q3BipwRCk(cn2mbhJqJ.q3BipwRCk, q7SwT3Brp.dIocxURUo), ((Number) ikjss0pml.q3BipwRCk(N3BTbW7KF.q3BipwRCk, Float.valueOf(q7SwT3Brp.kCA6Zs9sL))).floatValue(), (bZmnXN812) ikjss0pml.q3BipwRCk(WIrGVavNP.q3BipwRCk, q7SwT3Brp.iiGwOFFnr), ((Number) ikjss0pml.q3BipwRCk(sQROQ3MU2.q3BipwRCk, Float.valueOf(q7SwT3Brp.GPLPRo6go))).floatValue(), ((Number) ikjss0pml.q3BipwRCk(tu01bnfj0.q3BipwRCk, Float.valueOf(q7SwT3Brp.Puu3Rhg4F))).floatValue(), q7SwT3Brp.yWvV4ePLl, q7SwT3Brp.oon79WMrY, q7SwT3Brp.vPSbyrYWX, ((Number) ikjss0pml.q3BipwRCk(HyxPpglFl.q3BipwRCk, Float.valueOf(q7SwT3Brp.CBQ5d1kRq))).floatValue(), ((Number) ikjss0pml.q3BipwRCk(GF4NAjemZ.q3BipwRCk, Float.valueOf(q7SwT3Brp.kmSgne1rO))).floatValue(), ((Number) ikjss0pml.q3BipwRCk(gypiDXsbu.q3BipwRCk, Float.valueOf(q7SwT3Brp.Bhmn1KIah))).floatValue(), wpxpbwg1j, 8, 0, 0);
                        map4 = map2;
                    } else {
                        wpxpbwg1j = wpxpbwg1j2;
                        if (wdHQbIkKn instanceof ZOOhBHi6I) {
                            wpxpbwg1j.zHl31GGXU(-326286502);
                            Object obj3 = G7WvUK4mQ.q3BipwRCk;
                            ZOOhBHi6I zOOhBHi6I2 = (ZOOhBHi6I) wdHQbIkKn;
                            ikJSs0pML ikjss0pml2 = (ikJSs0pML) map2.get(zOOhBHi6I2.CBQ5d1kRq);
                            if (ikjss0pml2 == null) {
                                ikjss0pml2 = new bduREu7B4();
                            }
                            String str = zOOhBHi6I2.CBQ5d1kRq;
                            float floatValue = ((Number) ikjss0pml2.q3BipwRCk(VlBDqa3BM.q3BipwRCk, Float.valueOf(zOOhBHi6I2.kmSgne1rO))).floatValue();
                            float floatValue2 = ((Number) ikjss0pml2.q3BipwRCk(PfAhy0xEw.q3BipwRCk, Float.valueOf(zOOhBHi6I2.MzoOEjc4X))).floatValue();
                            float floatValue3 = ((Number) ikjss0pml2.q3BipwRCk(DuHoRM11M.q3BipwRCk, Float.valueOf(zOOhBHi6I2.ilHKhw3Yw))).floatValue();
                            float floatValue4 = ((Number) ikjss0pml2.q3BipwRCk(fuCEUm8BA.q3BipwRCk, Float.valueOf(zOOhBHi6I2.qVUwofr5s))).floatValue();
                            float floatValue5 = ((Number) ikjss0pml2.q3BipwRCk(toi198HGo.q3BipwRCk, Float.valueOf(zOOhBHi6I2.Eeka1udhb))).floatValue();
                            map4 = map2;
                            iiGwOFFnr(str, floatValue, ((Number) ikjss0pml2.q3BipwRCk(tsnruzigP.q3BipwRCk, Float.valueOf(zOOhBHi6I2.Bhmn1KIah))).floatValue(), ((Number) ikjss0pml2.q3BipwRCk(H09j2L9Ww.q3BipwRCk, Float.valueOf(zOOhBHi6I2.PSTqBLTET))).floatValue(), floatValue2, floatValue3, floatValue4, floatValue5, (List) ikjss0pml2.q3BipwRCk(aJPUy2D2j.q3BipwRCk, zOOhBHi6I2.dXrmkklc8), qFBXIgpia(wpxpbwg1j, -819898379, true, new s49RbLNOF(wdHQbIkKn, map2)), wpxpbwg1j, 939524096, 0);
                        } else {
                            map4 = map2;
                            wpxpbwg1j.zHl31GGXU(-326285032);
                        }
                    }
                    wpxpbwg1j.ilHKhw3Yw(false);
                    map2 = map4;
                    wpxpbwg1j2 = wpxpbwg1j;
                }
                map3 = map2;
            }
            map2 = map;
        ...
        rESgwfV20 Eeka1udhb = wpxpbwg1j2.Eeka1udhb();
        if (Eeka1udhb != null) {
            Eeka1udhb.dIocxURUo = new NhvTFl2Ja(zOOhBHi6I, map3, i, i2);
        }
    }
