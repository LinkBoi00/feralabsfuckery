...
public class jkxnNrP7Z extends MultiAutoCompleteTextView {
    ...
    public jkxnNrP7Z(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.autoCompleteTextViewStyle);
        GV6EZRqr3.q3BipwRCk(context);
        hfLGvn7bI.q3BipwRCk(this, getContext());
        j6XJY7rz4 mUqPm6GBh = j6XJY7rz4.mUqPm6GBh(getContext(), attributeSet, Bhmn1KIah, R.attr.autoCompleteTextViewStyle, 0);
        ...
        sfQ6fqrlg.iiGwOFFnr(attributeSet, R.attr.autoCompleteTextViewStyle);
        mZIyARhC1 mziyarhc1 = new mZIyARhC1(this);
        this.kmSgne1rO = mziyarhc1;
        mziyarhc1.kCA6Zs9sL(attributeSet, R.attr.autoCompleteTextViewStyle);
        mziyarhc1.J4Ux7ym32();
    }
