...
public final class i2nNh8aSS implements vc1fKXGpx {
    public final long CBQ5d1kRq;

    public i2nNh8aSS(long j, dnBSj5uJN dnbsj5ujn) {
        this.CBQ5d1kRq = j;
    }
    ...
    public boolean equals(Object obj) {
        i2nNh8aSS i2nnh8ass = obj instanceof i2nNh8aSS ? (i2nNh8aSS) obj : null;
        if (i2nnh8ass == null) {
            return false;
        }
        long j = this.CBQ5d1kRq;
        long j2 = i2nnh8ass.CBQ5d1kRq;
    ...
    public aZDaaZZJA kCA6Zs9sL(FRJidynr8 fRJidynr8, hKxHUWEcH hkxhuwech, long j) {
        ...
        int max = Math.max(dIocxURUo.CBQ5d1kRq, fRJidynr8.iiGwOFFnr(y8Q3RJgNN.J4Ux7ym32(this.CBQ5d1kRq)));
        int max2 = Math.max(dIocxURUo.kmSgne1rO, fRJidynr8.iiGwOFFnr(y8Q3RJgNN.q3BipwRCk(this.CBQ5d1kRq)));
        return fRJidynr8.nlGCs0NZs(max, max2, (r5 & 4) != 0 ? dmnvfTTyg.CBQ5d1kRq : null, new Td6hSVdwH(max, dIocxURUo, max2, 0));
    }
