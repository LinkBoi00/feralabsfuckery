...
public final class ihwWLIzx8 extends grdjLPaeu implements vc1fKXGpx {
    public final PmanMZxiM CBQ5d1kRq;

    public ihwWLIzx8(PmanMZxiM pmanMZxiM, PmanMZxiM pmanMZxiM2) {
        super(pmanMZxiM2);
        this.CBQ5d1kRq = pmanMZxiM;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ihwWLIzx8)) {
            return false;
        }
        return anXlDk6fV.tGV7Q6urW(this.CBQ5d1kRq, ((ihwWLIzx8) obj).CBQ5d1kRq);
    }
    ...
    public aZDaaZZJA kCA6Zs9sL(FRJidynr8 fRJidynr8, hKxHUWEcH hkxhuwech, long j) {
        ...
        return fRJidynr8.nlGCs0NZs(dIocxURUo.CBQ5d1kRq, dIocxURUo.kmSgne1rO, (r5 & 4) != 0 ? dmnvfTTyg.CBQ5d1kRq : null, new dMQC97DHs(dIocxURUo, this));
    }
    ...
    public String toString() {
        StringBuilder q3BipwRCk = abGBwSu8x.q3BipwRCk("BlockGraphicsLayerModifier(block=");
