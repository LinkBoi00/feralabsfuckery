...
public class VoOtBvrhx extends AnimatorListenerAdapter {
    ...
    public VoOtBvrhx(sSVv3dJln ssvv3djln, ltHymUmUx lthymumux, ViewPropertyAnimator viewPropertyAnimator, View view) {
    ...
    public void onAnimationEnd(Animator animator) {
        ...
        this.dIocxURUo.tGV7Q6urW(this.q3BipwRCk.q3BipwRCk);
        this.dIocxURUo.qVUwofr5s.remove(this.q3BipwRCk.q3BipwRCk);
    ...
    public void onAnimationStart(Animator animator) {
        ...
        RecyclerView.cywn6086a cywn6086a = this.q3BipwRCk.q3BipwRCk;
